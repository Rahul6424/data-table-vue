...
<td>'actionList'</td>
<td>Array of Objects</td>
<td>If you have opted for 'actions' column then you have to pass this field. Each object must contain.
<br>
'hoverTitle' : String -> Title which should be dislayed upon hover.<br>
